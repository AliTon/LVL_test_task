                ...
                <List.Item>
                    <NewsPageStyle>
                        <Link to={`/news/${item.id}`}>
                            ...
                            >
                                <Meta title={item.name} description={<div className="description">{item.text}</div>}/>
                                <div className='info'>
                                    <div><UserOutlined/> author: {item.author}</div>
                                    <div><EyeOutlined/> {item.views}</div>
                                    <div><CalendarOutlined/> {item.createdAt}</div>
                                </div>
                            </Card>
                        </Link>
                    </NewsPageStyle>
